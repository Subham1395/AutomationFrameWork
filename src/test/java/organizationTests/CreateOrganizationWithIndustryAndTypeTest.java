...
//		String PASSWORD = pUtil.readDatafromPropertyFile("password");
		...
		String ORGNAME = eUtil.readDataFromExcelUtility("Organizations", 7, 2) + jUtil.getRandomNumber();
		String INDUSTRY = eUtil.readDataFromExcelUtility("Organizations", 7, 3);
		String TYPE = eUtil.readDataFromExcelUtility("Organizations", 7, 4);
...
//		login.loginPage(USERNAME, PASSWORD);
		...
		cop.createNewOrganizationPage(ORGNAME, INDUSTRY, TYPE);
